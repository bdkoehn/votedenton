...
if ( has_nav_menu( 'primary' ) ) : ?>
	...
	<?php do_atomic( 'before_menu_primary' ); // vote_denton_before_menu_primary ?>

	<div id="menu-primary" class="menu-container row">

		<div class="span12">

			<?php do_atomic( 'open_menu_primary' ); // vote_denton_open_menu_primary ?>
			...
			<?php do_atomic( 'close_menu_primary' ); // vote_denton_close_menu_primary ?>

		</div><!-- .span12 -->

	</div><!-- #menu-primary.menu-container.row -->

	<?php do_atomic( 'after_menu_primary' ); // vote_denton_after_menu_primary ?>
