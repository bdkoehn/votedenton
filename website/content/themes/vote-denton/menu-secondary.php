...
if ( has_nav_menu( 'secondary' ) ) : ?>
	...
	<?php do_atomic( 'before_menu_secondary' ); // vote_denton_before_menu_secondary ?>

	<div id="menu-secondary" class="menu-container row">

		<div class="span12">

			<?php do_atomic( 'open_menu_secondary' ); // vote_denton_open_menu_secondary ?>
			...
			<?php do_atomic( 'close_menu_secondary' ); // vote_denton_close_menu_secondary ?>

		</div><!-- .span12 -->

	</div><!-- #menu-secondary.menu-container.row -->

	<?php do_atomic( 'after_menu_secondary' ); // vote_denton_after_menu_secondary ?>
