...
?>
	...
	<?php elseif ( is_search() ) : ?>
		...
		<div class="loop-meta">
			...
			<div class="loop-description">
				<p>
				<?php printf( __( 'You are browsing the search results for &quot;%1$s&quot;', 'enterprise' ), esc_attr( get_search_query() ) ); ?>
				</p>
			</div><!-- .loop-description -->
	...
	<?php elseif ( is_date() ) : ?>
		...
		<div class="loop-meta">
			<h1 class="loop-title"><?php _e( 'Archives by date', 'enterprise' ); ?></h1>

			<div class="loop-description">
				<p>
				<?php _e( 'You are browsing the site archives by date.', 'enterprise' ); ?>
				</p>
			</div><!-- .loop-description -->
	...
	<?php elseif ( is_archive() ) : ?>
		...
		<div class="loop-meta">
			...
			<h1 class="loop-title"><?php _e( 'Archives', 'enterprise' ); ?></h1>

			<div class="loop-description">
				<p>
				<?php _e( 'You are browsing the site archives.', 'enterprise' ); ?>
				</p>
			</div><!-- .loop-description -->
